...
import { faUser, faEnvelope, faLock, faEye, faCalendarDays } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="signin-signup">
                    <form onSubmit={handleSubmit} className="sign-up-form">
                        ...
                        <div className="input-field">
                            ...
                            <input type="text" id="nome" name='nome' placeholder="Nome Completo" value={formData.nome} onChange={handleChange} />
                        </div>
                        ...
                        <div id="inputLogin" className="input-field">
                            ...
                            <input id="senha" type="password" name='senha' placeholder="Senha" value={formData.senha} onChange={handleChange} />
                        </div>
